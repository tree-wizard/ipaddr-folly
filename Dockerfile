...
RUN mv /root/ipaddr-folly/replacements/deps.sh /root/proxygen/proxygen/deps.sh
RUN mv /root/ipaddr-folly/replacements/FollyConfigChecks.cmake /root/proxygen/proxygen/folly/CMake/FollyConfigChecks.cmake
RUN mv /root/ipaddr-folly/replacements/Subprocess.cpp /root/proxygen/proxygen/folly/folly/Subprocess.cpp
RUN mv /root/ipaddr-folly/replacements/Range.h /root/proxygen/proxygen/folly/folly/Range.h
